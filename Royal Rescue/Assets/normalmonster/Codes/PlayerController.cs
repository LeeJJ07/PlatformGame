...
public class PlayerController : MonoBehaviour
{
    ...
    IEnumerator Atk()
    {
        ...
        Collider[] collisions = Physics.OverlapBox(hand.transform.position + new Vector3(2, 0, 1),new Vector3(2, 2, 1), transform.rotation, LayerMask.GetMask("Boss"));
        foreach(Collider collision in collisions)
        {
            collision.GetComponent<EnemyAI>().HitDamage(1);
        }
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(hand.transform.position+ new Vector3(2, 0, 1), new Vector3(2, 2, 1));
    }
}